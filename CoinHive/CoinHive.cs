        ...
        */
        ...
        public void VerScript(double amt_hash, int interval, string WinPosition)
        {
          ...
          IWebElement el;
            ...
            {
                //  double.TryParse(driver.FindElement(By.Id("hps")).ToString(), out hps);
                //double.TryParse(driver.FindElement(By.Id("th")).ToString(), out th);
                //double.TryParse(driver.FindElement(By.Id("ah")).ToString(), out ah);
